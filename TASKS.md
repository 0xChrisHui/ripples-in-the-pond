...
- 待用户指派下一刀。**Track A A3+A12+A8 已完结**（2026-05-16，commit `a48f4de`，真实数据端到端验证）。下一步建议 A4 MAINNET-RUNBOOK grantRole 验收命令（小步快跑）或 A14/A15（auto-polling + 失败回滚，已就绪）。
...
- [x] D4 verify.sh 全绿；浏览器 7 步实测待用户本机确认（2026-05-15）
