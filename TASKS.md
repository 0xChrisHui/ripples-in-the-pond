...
- **Phase 12 主网准备进行中**（2026-08-23，分支 `feat/p12-mainnet-prep`）：A-1/C2 + smoke ✅；B-1/B5 ✅；Optimism Mainnet Alchemy App 已由官方 CLI 创建并验证 chainId 10 ✅。**当前唯一 Now（人工硬前置）：取得 OP Etherscan API key**；可并行做 C6 六服务额度盘点。权威口径见 `STATUS.md`「P12 执行进度」。
