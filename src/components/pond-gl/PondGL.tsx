    ...
    <div className="pointer-events-none fixed inset-0 z-0">
      <GLErrorBoundary fallback={<GlFallback artDir={flags.artDir} />}>
        ...
        >
          ...
          {flags.waterFx && <WaterDistort debug={flags.waterDbg} glSim={glSim} depthModel={flags.depthModel} sphereShadow={flags.sphereShadow} caustics={flags.caustics} waterZoom={flags.waterZoom} />}
