...
| **Phase 13** | Semi 音乐 NFT 生态合作 | 待定（你先和社区商量） |
| **Phase 14** | 钱包配方音乐 NFT 自动空投 | 启动时重估 |
| **Phase 15** | 全站丝滑体验与永久播放可靠性 | 启动时按基线重估 |
| **Phase 16** | 原生钱包 + 多链 / ETH Mainnet | 待定（往后排） |

> 原 P15“音效系统扩展”已于 2026-09-05 退回未排期清单，不自动占用 P16。
