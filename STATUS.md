...
**Phase**: **Phase 11-I「主线重放与效果对齐」执行中**。I0 自动基准与 I1 四项独立修复全部完成：档案外键、旧数字 Score 主网身份、首播镜像默认值、Tailwind 扫描边界均已通过对应 Gate。当前进入 I2 共享水塘外壳。
...
**当前权威下一步**：执行 P11-I2，共享 Water Core 外壳只搭架子，保持首页 B01–B08 的既有效果。I0 用户确认与日食肉眼目验列在晨报。
