...
**Phase**: **Phase 11-I「主线重放与效果对齐」执行中**。I0 自动基准与 I1 四项独立修复全部完成：档案外键、旧数字 Score 主网身份、首播镜像默认值、Tailwind 扫描边界均已通过对应 Gate。I2 共享水塘外壳已完成（首页与 `/me` 共用同一 Water Core，三次往返 mountId/Canvas 稳定，完整 verify 通过）；当前进入 I3 路由转场。
...
**当前权威下一步**：执行 P11-I3，`/ ↔ /me` 可逆路由转场。I2 共享水塘外壳已完成并本地提交；I0 用户确认、首页动态对照与日食肉眼目验列在晨报。
