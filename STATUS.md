...
**Phase**: **Phase 11-I「主线重放与效果对齐」执行中，进入 I6**。I0–I5 已完成；首页后台预备唯一私人档案，未登录时不请求私人数据，档案 ready/明确失败后才完成转场。`/me` 的首页演奏键与交互控件涟漪均已隔离，四视口、同一 Water Core/Canvas 与完整 verify（构建 38/38、Forge 56/56）通过；证据见 `reviews/evidence/p11-i/i5-gate.md`。
...
**当前权威下一步**：执行 P11-I6，把作品页接入共享水面并重点复验日食、播放与离页清理。I0 用户确认、登录档案目验与日食肉眼确认列在晨报。
